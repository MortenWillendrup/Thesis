...
The outstanding amount as of `r str_to_sentence(format(zoo::as.yearmon(real_marked[ which(real_marked$TID==max(real_marked$TID)), ][[10]][[1]]), "%B %Y"))` in the Danish mortgage market is DKK `r format(market_size/1000, scientific=F)` Billions 
